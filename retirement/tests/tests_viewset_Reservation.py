...
class ReservationTests(CustomAPITestCase):
    ...
    def test_delete_free(self):
        """
        Ensure that a user can cancel one of his retreat reservations that was free.
        The user will not have any refund since it was free, even by canceling
        'min_day_refund' days or more before the event, t.
